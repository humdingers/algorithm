...
public class FindCheapestPrice
{
            ...
            for (int nei = 0; nei < n; nei++) {
                if (graph[place][nei] > 0) {
                    ...
                    if (newcost < best.getOrDefault((k + 1) * 1000 + nei, Integer.MAX_VALUE)) {
                        pq.offer(new int[] {newcost, k + 1, nei}); // 比较更新完之后的cost最少的点，就是新一轮的出发点
                        best.put((k + 1) * 1000 + nei, newcost); // 更新到达节点cost
                    }
                }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.print(findCheapestPrice(n, flights, src, dst, K));
